...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $category->save();
        return redirect()->route('author.category.index')->with('sukses', 'Data category berhasil ditambahkan.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $category->image = $imagename;
        $category->save();
        return redirect()->route('author.category.index')->with('sukses', 'Data category berhasil diedit.');
    }

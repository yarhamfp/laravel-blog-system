...
@section('title')
{{App\Setting::first()->name.App\Setting::first()->subname}} | Show Post
@endsection
@section('content')
      ...
      <div class="col-lg-4 col-xl-3 mb-4">
          ...
          <div class="card bg-dark border-0">
              <div class="card-body">
                  ...
                  <div class="card-footer bg-transparent pt-0 border-0 text-right"><a class="btn btn-light btn-sm" href="{{route('admin.post.index')}}"><i class="fa fa-arrow-left"></i> &nbsp; Kembali</a></div>
              </div>
            </div>
      </div>

            ...
            <div class="tab-content" id="cardPillContent">
                ...
                <div class="tab-pane fade show active" id="overviewPill" role="tabpanel" aria-labelledby="overview-pill">
                  <div class="card card-header-actions mb-4">
                    <div class="card-header"><a href="{{route('admin.dashboard')}}" class="btn btn-primary btn-icon"><i class="fa fa-arrow-left"></i></a> Edit Profile
                    </div>
                    <div class="card-body">
                ...
                <div class="tab-pane fade" id="activitiesPill" role="tabpanel" aria-labelledby="activities-pill">
                  <div class="card card-header-actions mb-4">
                    <div class="card-header"><a href="{{route('admin.user.index')}}" class="btn btn-primary btn-icon"><i class="fa fa-arrow-left"></i></a> Reset Password
                    </div>
                    <div class="card-body">
                        <div class="sbp-preview">
                          <div class="sbp-preview-content">

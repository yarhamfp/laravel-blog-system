...
@section('title')
{{App\Setting::first()->name.App\Setting::first()->subname}} | Create Category
@endsection
@section('content')
  ...
  <div class="row">
    <div class="col-lg-8 mx-auto">
      <div class="card card-header-actions mb-4">
        <div class="card-header"><a href="{{route('admin.category.index')}}" class="btn btn-primary btn-icon"><i class="fa fa-arrow-left"></i></a> Tambah Category
        </div>
        <div class="card-body">

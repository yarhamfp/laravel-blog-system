  ...
  <div class="container-fluid">
      <div class="page-header-content">
          ...
          <ol class="breadcrumb mt-4 mb-0">
            ...
            <li class="breadcrumb-item"><a href="{{route('author.comment.index')}}">Comment</a></li>
    ...
    <div class="col-lg-8 mx-auto">
      <div class="card card-header-actions mb-4">
        <div class="card-header">
          <a href="{{route('author.comment.index')}}" class="btn btn-primary btn-icon"><i class="fa fa-arrow-left"></i></a> Reply Comment
        </div>
        <div class="card-body">
                ...
                <div class="media">
                  ...
                  <div class="media-body">
                    ...
                    <div class="media mt-3">
                      ...
                      <form id="delete-comment" action="{{route('author.reply.destroy',$item->id)}}" method="POST" class="d-inline">
                        @csrf
                        @method('delete')

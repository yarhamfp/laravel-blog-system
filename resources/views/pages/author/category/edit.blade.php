...
@section('title')
{{App\Setting::first()->name.App\Setting::first()->subname}} | Edit Category
@endsection
@section('content')
<div class="page-header pb-10 page-header-dark bg-gradient-primary-to-secondary bg-img-repeat" style="background-image: url('{{ url('backend/assets/img/pattern-shapes.png')}}');">
  <div class="container-fluid">
      <div class="page-header-content">
          ...
          <div class="page-header-subtitle">Edit your category
          </div>
  ...
  <div class="row">
    <div class="col-lg-8 mx-auto">
      <div class="card card-header-actions mb-4">
        <div class="card-header"><a href="{{route('author.category.index')}}" class="btn btn-primary btn-icon"><i class="fa fa-arrow-left"></i></a> Edit Category
        </div>
        <div class="card-body">
            <div class="sbp-preview">
              <div class="sbp-preview-content">
                <form action="{{route('author.category.update',$item->id)}}" method="POST" enctype="multipart/form-data">
                  @method('PUT')
                  @csrf
                  <div class="form-group ">
                    <label for="name">Name Category *</label>
                    <input class="form-control shadow-right {{$errors->has('name') ? ' border-danger' : ''}}" id="name" name="name" type="text" value="{{$item->name}}">
                    @if ($errors->has('name'))
                  ...
                  <div class="form-group">
                    ...
                    <img src="{{ Storage::disk('public')->url('category/'.$item->image)}}" class="img-thumbnail">
                  </div>
                  <div class="form-group ">
